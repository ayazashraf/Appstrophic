...
<meta name="Keywords" content="seo in uae, online marketing services dubai, social media agency, appstrophic, appstrophic uae, appstrophic dubai">
<meta name="Description" content="Market your business worldwide by availing best services of social media agency &amp; SEO in UAE. Just sit back &amp; let the experts promote your business globally.">
<title>Online Marketing Services UAE | Appstrophic Dubai</title>
...
<div class="gridContainer clearfix">
  <div id="InnerWrapper">
    ...
    <center> <img src="../../../../../images/banners/online marketing.jpg"></div></center>
               ...
               <section id="Body">
                 <div class="ContentBlock" style="height:175px;">
                   <h1 style="font-size:36px"><strong>
                     <div class="colour">Online Maketing</div>
                   </strong></h1>
                   <p align="left">With the increasing popularity of World Wide Web across the planet, marketing has also become global increasing the competition between companies. Before internet, business was bound to increase only in certain locality. But now, web has broken all of the boundaries & lets you market your brand globally.</p>
                 </div>
                 <div class="ContentBlock" style="height:190px;">
               	  <div class="ContentText">
                    	<h1>Targeted Audience</h1>
                		<p align="left">Internet marketing isn’t a child’s play. It requires proper strategy, special keywords & hundreds of techniques to rank the desired website amongst its rivalries. To deal with this difficult situation and to make your lives a heaven our teams of <a href="smm/index.php" style="color:#565143;font-weight:
bold;">Social media Agency</a> & <a href="seo/index.php" style="color:#565143;font-weight:
bold;">SEO Services in Dubai</a> are available at your service. </p>
                   </div>
                    <div class="ContentImage" style="right:15px;"><img src="<?php echo BASE_URL; ?>/images/content_images/target.png"></div>
                </div>
                <div class="ContentBlock" style="height:210px;">
                	<div class="ContentText" style="right:10px;">
                        <h1>See your web Up</h1>
                        <p align="left">Our skilled marketing personnel know how to tackle every type of problems. They have worked for almost every category of websites. Getting targeted audience is most important if you want to get prosper & with our teams of hardworking online marketing you can rely on us. So hand up your worries to us & see your website ranks up to the very 1st page of the best search engines especially Google.</p>
                    </div>
                    <div class="ContentImage" style="left:15px;"><img src="<?php echo BASE_URL; ?>/images/content_images/web up.png"></div>
                </div>
