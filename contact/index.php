...
<meta name="Keywords" content="mobile apps developer, web applications, web development in dubai, appstrophic, appstrophic dubai, creative graphic designer, web services uae, cross-platform development">
<meta name="Description" content="Build your own mobile &amp; web applications regardless of platforms with experienced teams of apps developers &amp; creative graphic designers of Appstrophic Dubai.">
<title>Mobile apps developer | Logo Designers | Web Services in UAE</title>
...
<div class="gridContainer clearfix">
  <div id="InnerWrapper">
    ...
    <div class="MainBanner">
    	 <center> <img src="../../../../../images/banners/contact banner.jpg"></div></center>
    ...
    <section>
    	<div class="FixedWrapper">
            ...
            <section id="Body">
                ...
                <table width="100%">
                	<tr>
                    	<td width="20%"><img src="../images/contacticon.png" alt="Contact us" width="77" height="78"></td>
                        <td><p style="line-height:18px;">Become a part of huge<strong> Appstrophic’s</strong> clientele by appointing us for your valuable works. Our team of android app developers, iPhone app developer, facebook app developer & many distinct application manufacturers belonging to diverse platforms are always ready to serve you. After all<a href="../index.php" style="color:#565143;font-weight:
bold;"> We Are On Your Click!!</a></p></td>
                    </tr>
                </table>
				<h1>Locate us</h1>
                <div class="LocateMap" style="margin:40px auto; width:475px;">
